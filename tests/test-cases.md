...
| Test Case ID | Feature | Steps | Expected Result | Status | Comments | Owner/Executor | Testing Environment | GitHub Issue |
| ------------ | -------- | ------ | ---------------- | ------ | -------- | -------------- | --------------------- | ------------ |
| TC001 | Valid Login | Open `/login` → Enter valid email & password → Click **Log in** | Redirected to dashboard with welcome message | Pass | | QA Team | Chrome, Firefox, Edge | |
...
| TC040 | Admin Access | Login as admin → Go to `/admin` | Admin dashboard loads | Pass | | QA Team | Chrome, Firefox, Edge | |
| TC041 | View All Requests | Open request list | All user requests displayed | Fail | | QA Team | Chrome, Firefox, Edge | |
| TC042 | Filter by Location | Use filter → Select city | Requests filtered correctly | Fail | | QA Team | Chrome, Firefox, Edge | |
...
| TC103 | Feedback Analytics | Admin views feedback summary | Analytics charts correct | Fail | | QA Team | Chrome, Firefox, Edge | |
| TC104 | Search Blog Posts | Enter keyword → Search | Matching blog posts displayed | Pass | | QA Team | Chrome, Firefox, Edge | |
| TC105 | Pagination Blog Posts | Navigate pages in `/blog` | Correct posts displayed per page | Pass | | QA Team | Chrome, Firefox, Edge | |
...
| TC112 | Community Forum Report | Report inappropriate post | Admin notified, post flagged | Fail | | QA Team | Chrome, Firefox, Edge | |
| TC113 | Gamification – Points Earn | Complete a pickup → Earn points | User points updated correctly | Pass | | QA Team | Chrome, Firefox, Edge | |
